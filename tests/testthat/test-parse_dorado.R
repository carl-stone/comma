...
test_that("cigarToRefPos: simple all-match CIGAR", {
    ...
    result <- commaKit:::.cigarToRefPos("5M", ref_start = 100L, seq_bases = "ACGTA")
...
test_that("cigarToRefPos: CIGAR with deletion", {
    ...
    result <- commaKit:::.cigarToRefPos("3M2D2M", ref_start = 100L, seq_bases = "ACGTA")
...
test_that("cigarToRefPos: CIGAR with insertion", {
    ...
    result <- commaKit:::.cigarToRefPos("3M2I2M", ref_start = 100L, seq_bases = "ACGTAAG")
...
test_that("cigarToRefPos: CIGAR with soft clip", {
    ...
    result <- commaKit:::.cigarToRefPos("2S3M", ref_start = 50L, seq_bases = "XXACG")
...
test_that("cigarToRefPos: malformed CIGAR with trailing junk returns NULL", {
    result <- commaKit:::.cigarToRefPos("5Mbogus", ref_start = 1L, seq_bases = "ACGTA")
    expect_null(result)
})

test_that("cigarToRefPos: overlong CIGAR does not corrupt mapped prefix", {
    result <- commaKit:::.cigarToRefPos("3M3M", ref_start = 10L, seq_bases = "ACGTA")
...
test_that("cigarToRefPos: hard clip (H) does not consume read positions", {
    ...
    result <- commaKit:::.cigarToRefPos("2H5M", ref_start = 10L, seq_bases = "ACGTA")
...
test_that("cigarToRefPos: mixed soft-clip and match assigns NA then ref positions", {
    ...
    result <- commaKit:::.cigarToRefPos("3S2M", ref_start = 50L, seq_bases = "XXXAC")
...
test_that("cigarToRefPos: N (skipped region) advances reference like deletion", {
    ...
    result <- commaKit:::.cigarToRefPos("2M3N2M", ref_start = 100L, seq_bases = "ACGT")
