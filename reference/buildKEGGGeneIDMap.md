...
#> KEGG ID map cached to: /tmp/RtmpoBIODm/eco_id_map.rds
#> Done. 4634 gene symbols mapped to KEGG IDs.
#> Fetching KEGG pathway data for organism 'eco' ...
#> KEGG data cached to: /tmp/RtmpoBIODm/eco_kegg.rds
#> Done. 4968 gene-pathway associations across 138 pathways.
