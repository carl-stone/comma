...
#> KEGG ID map cached to: /tmp/RtmpRL4L2r/eco_id_map.rds
#> Done. 4634 gene symbols mapped to KEGG IDs.
#> Fetching KEGG pathway data for organism 'eco' ...
#> KEGG data cached to: /tmp/RtmpRL4L2r/eco_kegg.rds
#> Done. 4963 gene-pathway associations across 137 pathways.
