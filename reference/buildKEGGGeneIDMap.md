...
#> KEGG ID map cached to: /tmp/RtmphmDAqB/eco_id_map.rds
#> Done. 4634 gene symbols mapped to KEGG IDs.
#> Fetching KEGG pathway data for organism 'eco' ...
#> KEGG data cached to: /tmp/RtmphmDAqB/eco_kegg.rds
#> Done. 4970 gene-pathway associations across 137 pathways.
